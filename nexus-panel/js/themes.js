...
export const PRESET_THEMES = [
  ...
  },
  {
    ...
    /* 扁平补充：深 3 + 浅 3。
       原先深色扁平偏"高饱和科技感"（霓虹/赛博/终端绿），浅色偏"纸质暖调"
       （素笺/燕麦/橄榄），两头都缺**低饱和、靠明度分层**的日常款 ——
       长时间看屏幕时，高饱和最累眼。

       配色都按测试口径算过：正文@底色 ≥4.5、弱化文字 ≥3.0、
       角标白/黑字取较优者 ≥4.5、承载面之间 ΔL* 拉得开（不糊成一片）。
       改任何一个值前请重跑 theme-test。 */
  {
    id: 'midnight-blue',
    name: '午夜蓝',
    desc: 'GitHub Dark 风 · 深蓝灰，蓝紫点缀',
    base: 'dark',
    style: 'flat',
    vars: {
      '--bg': '#0d1117',
  ...
  {
    /* id 带 -flat：新拟态里已有一套同名 'graphite'，主题按 id 存覆盖与自定义，
       撞 id 会让两套互相顶掉（用户改 A 的设置，B 跟着变）。 */
    id: 'graphite-flat',
    name: '石墨',
    desc: '中性深灰 · 极低饱和，靠明度分层',
    base: 'dark',
    style: 'flat',
    vars: {
      '--bg': '#1c1c1e',
  ...
  /* ---------------- 玻璃 ---------------- */
  {
    ...
    vars: {
      ...
      '--surface-overlay': 'rgba(47, 53, 74, 0.96)',
  ...
  },
  {
    ...
    vars: {
      ...
      '--surface-overlay': 'rgba(38, 31, 71, 0.96)',
    ...
    },
    {
      ...
      vars: {
        ...
        '--surface-overlay': 'rgba(31, 37, 60, 0.96)',
    ...
    },
    {
      ...
      vars: {
        ...
        '--surface-overlay': 'rgba(63, 50, 38, 0.96)',
