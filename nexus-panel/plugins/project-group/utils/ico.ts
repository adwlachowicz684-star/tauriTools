 ...
 *
 * 此前只有 16/32/48/256 四档。缺 24/64/128 的实际后果：
 * 资源管理器在「中等图标 / 大图标 / 特大图标」等视图下要取 48 与 256
 * **之间**的档位，没有对应帧就只能把 32 放大或把 256 缩小 ——
 * 表现为图标发虚 / 边缘糊，而用户看不出那是"少了档位"造成的，
 * 只会觉得"这个图标转换质量差"。且没有任何报错。
 */
