 ...
 *
 * ⚠️ 这一行被同步提交覆盖丢失过多次（2026-09-26 已第 4 次）：
...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            fpx::fpx_rename_icon,
            fpx::fpx_pick_color, fpx::fpx_save_custom_colors, fpx::fpx_list_fav_dirs, fpx::fpx_save_fav_dirs,
            fpx::fpx_open_data_dir, fpx::fpx_open_backup_dir,
